...
public final class AutoTuneConfig {
    ...
    public AutoApplyMode autoApplyMode = null;
    public OptimizationEngineMode optimizationEngineMode = OptimizationEngineMode.OFF;
    public boolean particleReductionEnabled = true;
    @Deprecated
    ...
    private void sanitize() {
        ...
        if (autoApplyMode == null) {
            autoApplyMode = applyPresetOnWorldJoin ? AutoApplyMode.SELECTED_PRESET : AutoApplyMode.OFF;
        }
        if (optimizationEngineMode == null) {
            optimizationEngineMode = OptimizationEngineMode.OFF;
        }
        if (aggressiveMode && optimizationEngineMode == OptimizationEngineMode.OFF) {
            optimizationEngineMode = OptimizationEngineMode.AGGRESSIVE;
        }
        aggressiveMode = false;
        applyPresetOnWorldJoin = autoApplyMode != AutoApplyMode.OFF;
    }
}
