...
public final class AutoTuneFpsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        OptimizationEngine optimizationEngine = new OptimizationEngine(config);
        optimizationEngine.initialize();
        AutoTuneClientCoordinator coordinator = new AutoTuneClientCoordinator(presetApplier, optimizationEngine);

        ClientCommandCompat.register(coordinator);
        ClientLifecycleCompat.register(coordinator);
