...
- Added support for Minecraft `1.21` alongside the existing `1.21.1` through `1.21.11` line
- Fixed cross-version graphics option detection used by preset and restore actions
