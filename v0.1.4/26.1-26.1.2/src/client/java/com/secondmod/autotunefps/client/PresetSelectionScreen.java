...
public final class PresetSelectionScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.centeredText(
            this.font,
            Component.literal("Detected hardware: " + formatDetectedTierLabel()),
            this.width / 2,
            26,
            0xFFA0A0A0
        );
        guiGraphics.centeredText(
            this.font,
            Component.literal("Recommended: " + formatRecommendedInfoLabel()),
            this.width / 2,
            38,
            0xFFA0A0A0
        );
        guiGraphics.centeredText(
            this.font,
            Component.literal("Selected: " + formatSelectedPresetLabel()),
            this.width / 2,
            50,
            0xFFA0A0A0
        );
