...
public final class HardwareProfileDetector {
    ...
    public HardwareProfile detect(Minecraft client) {
        try {
            ...
            boolean fabulousSafe = tier == HardwareTier.HIGH && !shadersActive && !hasRiskFlags && !sodiumLoaded;

            return new HardwareProfile(tier, cpuScore, ramScore, gpuScore, renderer, vendor, shadersActive, hasRiskFlags, sodiumLoaded, fabulousSafe);
