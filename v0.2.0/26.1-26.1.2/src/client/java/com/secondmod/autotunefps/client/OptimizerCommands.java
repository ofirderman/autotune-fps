...
public final class OptimizerCommands {
    ...
    private static int showHelp(FabricClientCommandSource source) {
        return feedbackLines(
            ...
            "- /optimizer presets -> explains each preset and marks selected",
            "- /optimizer recommend -> applies the Smart Recommendation",
            "- /optimizer preview recommended -> preview the Smart Recommendation",
            "- /optimizer preview <preset> -> show what a preset would change",
            "- /optimizer preset <preset> -> applies a preset manually",
            "- /optimizer autoapply off/selected/smart -> choose join-time auto-apply",
            "- /optimizer aggressive on/off -> toggle extra tuning for more FPS",
            "- /optimizer status -> show selected preset, recommendation, restore, and protected settings info",
            ...
            "- Smart Recommendation never picks ultimate_performance"
        );
    }
