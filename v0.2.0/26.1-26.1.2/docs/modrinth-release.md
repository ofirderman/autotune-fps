...
- Minecraft versions: `26.1` through `26.1.2`
- Companion supported range: `1.21` through `1.21.11` is shipped by the sibling 0.2.0 jar.
- Loaders: `Fabric`
- Environment: `Client`
...
The 0.2.0 release also includes the sibling `1.21` through `1.21.11` jar:
...
4. Mark the intended `26.1-26.1.2` versions from `26.1` through `26.1.2`, and loader `Fabric`.
